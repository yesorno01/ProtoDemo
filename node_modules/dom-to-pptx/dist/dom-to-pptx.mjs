 ...
 */
async function normalizePptxZip(zip) {
  if (!zip) return;
...
function getTextStyle(style, scale, includeMargins = true, inheritedOpacity = 1) {
...
function getWritingModeVert(writingMode, textOrientation) {
...
function collectTextParts(node, parentStyle, scale, activeHyperlink = null, isRoot = true, inheritedOpacity = 1) {
  const parts = [];
