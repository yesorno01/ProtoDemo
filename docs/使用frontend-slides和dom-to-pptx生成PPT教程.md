...
> "帮我制作一个关于 e矿汇平台安全保障体系的汇报 PPT，5-8页，面向集团领导汇报，用业务语言、场景化表达"
...
制作一个"e矿汇平台安全保障体系"汇报 PPT，面向集团领导，1-2分钟汇报，场景化表达。

### Step 1：用 frontend-slides 生成 HTML

向 AI 提问：（此处可以引用写好的配色规范）

> "帮我制作一个关于e矿汇平台安全保障体系的汇报PPT，5页左右，面向集团领导，用业务语言、场景化表达。风格选 Dark Botanical，配色用中矿品牌色（矿业金 #B89A4B、深棕褐 #6B4423、米白 #F5F0E6）"
...
```bash
cd d:\A\gProjectM\ProtoDemo\ppt\e矿汇安全目标
npx serve .
```

浏览器打开 `http://localhost:3000/e矿汇安全汇报.html`，点击「导出 PPTX」。
